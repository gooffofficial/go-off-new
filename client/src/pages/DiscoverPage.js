			...
			<div className={styles['di-mainContent']}>
				<div className={styles['di-leftColumn']}>
					<div className={styles['di-avatarBox']}>
						<img
							src={prekshaIcon}
							alt="avatar"
							className={styles['di-prekshaIcon']}
						/>
					...
					<div className={styles['di-upcomingChats']}>
						<DIChatCard
							...
							timeStart="THURSDAY, MAY 22 AT 10 PM EST"
							chatImage="/brushChat.png"
						/>
						<DIChatCard
							title="Zero Waste Toothbrush: How does it really make a difference?"
							timeStart="THURSDAY, MAY 22 AT 10 PM EST"
				...
				<div className={styles['di-rightColumn']}>
					...
					<div className={styles['di-browseRow2']}>
						<div className={styles['di-browseBox di-popCultureBox']}>
							Pop Culture
						</div>
						<div className={styles['di-browseBox di-artBox']}>Art</div>
						<div className={styles['di-browseBox di-SustainabilityBox']}>
							Sustainability
						</div>
					</div>
				</div>
...
const DINavBar = ({}) => {
	return (
		<div className={styles['di-navbar']}>
			<img
				src={goOffLogo}
				alt="Go Off! Logo"
				className={styles['di-goOffLogo']}
			/>
			<div className={styles['di-searchBar']}>
				<img
					src={searchIcon}
					alt="Search Icon"
					className={styles['di-searchIcon']}
				/>
				<input
					type="search"
					className={styles['di-searchInput']}
					placeholder="Search"
				/>
				<img
					src={optionsIcon}
					alt="Settings"
					className={styles['di-optionsIcon']}
				/>
			</div>
			<img
				src={addPersonIcon}
				alt="Add person"
				className={styles['di-addPersonIcon']}
			/>
			<img
				src={bellIcon}
				alt="Notifications"
				className={styles['di-bellIcon']}
			/>
			...
			<div className={styles['di-navProfileBox']}>
				<div className={styles['di-profile']}>
					<img
						src={prekshaIcon}
						alt="avatar"
						className={styles['di-profileIcon']}
					/>
					<span className={styles['di-profileText']}>Preksha Munot</span>
					<img
						src={arrowDownIcon}
						alt="dropDown"
						className={styles['di-arrowDownIcon']}
					/>
				</div>
			</div>
		</div>
...
const DIChatCard = ({ title, timeStart, chatImage }) => {
	return (
		<div className={styles['di-chatCard']}>
