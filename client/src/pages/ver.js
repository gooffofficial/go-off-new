      ...
      <div className="whole-container">
        <div className="left-side">
            <div className="left-container">
              ...
              <span className={styles["dot"]} id="pdot1" style={{background: "#3A86FF", left: "40%"}}></span>
              <span className={styles["bar"]} id="pbar1" style={{background: "#3A86FF", left: "40%"}}></span>
              <span className={styles["dot"]} id="pdot2" style={{background: "#3A86FF", left: "45%"}}></span>
              <span className={styles["bar"]} id="pbar2" style={{background: "#3A86FF", left: "45%"}}></span>
              <span className={styles["dot"]} id="pdot3" style={{background: "#3A86FF", left: "50%"}}></span>
