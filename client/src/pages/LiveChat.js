			...
			<div className={styles['rightMessageBox']}>
				...
				<div className={styles['chatMessageBox']}>
					<span className={styles['messageText']}>
						Hi everyone! Thank you so much for joining my converstation! I look
						forward to having exciting and meaningful conversations with all of
						you!
					</span>
				</div>
			</div>
	...
	return (
		<div className={styles['otherMessageBox']}>
			<div className={styles['leftMessageBox']}>
				...
				<div className={styles['chatMessageBox']}>
					<span className={styles['messageText']}>
						Thank you Emily for hosting this conversation! I am very excited to
						have this discussion with all of you and see what everyone has to
