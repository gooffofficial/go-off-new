      ...
      <div className={styles["ep-rightContent"]}>
        <div className={styles["ep-headingRow"]}>
          <div className={styles["ep-leftHeading"]}>
            ...
            <h2 className={styles["ep-hDescription"]}>Users will be able to view the information provided.</h2>
          </div>
        ...
        <div className={styles["ep-profImgRow"]}>
          ...
          <div className={styles["ep-rightProfImg"]}>
            <button className={styles["ep-chooseFileBtn"]}>Choose File</button>
...
const EPNavBar = ({}) => {
  return <div className="ep-navbar">
    ...
    <div className={styles["ep-optionsRow"]}>
      ...
      <a href="##" className={styles["ep-amount"]}>0</a>
      <img src="/plus.svg" alt="" className={styles["ep-plus"]} />
    </div>
    <div className={styles["ep-profileRow"]}>
      <img src="https://miro.medium.com/max/316/1*LGHbA9o2BKka2obwwCAjWg.jpeg" className={styles["ep-profileAvatar"]} alt="profileAvatar" />
      <img src="/chevron_down.svg" className={styles["ep-arrowDown"]} alt="" />
    </div>
  </div>
}
