...
(function () {
	...
	if (socket !== undefined) {
		...
		home.addEventListener('click', function () {
			...
			if (!alert('Please fill out this survey before leaving the conversation! Copy and paste the following link in a new window: https://bostonu.qualtrics.com/jfe/form/SV_1SxxCfIbHjfRDKd/')) {
				var url = 'https://go-off.co/profiles/' + username.textContent
				window.open(url, '_self');
			}
